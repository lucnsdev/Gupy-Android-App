    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkBoxHybrid.isChecked()) {
                    if (type == null) type = Vacancy.TYPE_HYBRID;
                    else type += "," + Vacancy.TYPE_HYBRID;
                }
                if (checkBoxRemote.isChecked()) {
                    if (type == null) type = Vacancy.TYPE_REMOTE;
                    else type += "," + Vacancy.TYPE_REMOTE;
                }
                try {
