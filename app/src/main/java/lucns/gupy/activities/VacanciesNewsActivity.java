...
public class VacanciesNewsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                if (item.getItemId() == R.id.vacancy_search) {
                    ...
                    startActivity(new Intent(VacanciesNewsActivity.this, ExecutionVacanciesSearchActivity.class), ActivityOptions.makeSceneTransitionAnimation(VacanciesNewsActivity.this).toBundle());
                    new Handler(Looper.getMainLooper()).postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            finish();
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                textLastUpdate.setText(R.string.updating);
        ...
        ServiceInstantiator.getInstance(this, new ServiceInstantiator.OnServiceAvailableListener() {
            ...
            public void onAvailable(MainService mainService) {
                VacanciesNewsActivity.this.mainService = mainService;
            }
        });

        IntentFilter filter = new IntentFilter();
        filter.addAction(JobSchedulerService.ACTION_NEWS);
        filter.addAction(JobSchedulerService.ACTION_NO_NEWS);
    ...
    protected void onPause() {
        ...
        if (hasRegisteredVacancies() && !isJobServiceRunning() && !mainService.isRunning()) startSchedule(false);
    }
    ...
    private final BroadcastReceiver newsReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            if (intent.getAction().equals(JobSchedulerService.ACTION_NO_NEWS)) {
                Utils.vibrate();
